...
| US07 | Perfil de coach | Como usuario, quiero ver información detallada del coach para evaluar su experiencia y decidir si contratarlo. | **Escenario 1: Visualización completa del perfil**<br>Dado que el usuario ha seleccionado un coach de los resultados de búsqueda,<br>Cuando accede a la página de detalle del coach,<br>Entonces el sistema muestra: foto de perfil, nombre completo, años de experiencia, especialidades, tarifa por hora, calificación promedio con número de reseñas, y los últimos 3 comentarios de clientes.<br><br>**Escenario 2: Coach sin reseñas aún**<br>Dado que el coach es nuevo y no ha recibido calificaciones,<br>Cuando el usuario accede a su perfil,<br>Entonces el sistema muestra el mensaje "Este coach aún no tiene reseñas. ¡Sé el primero en calificarlo!" en lugar de la sección de reseñas vacía.<br><br>**Escenario 3: Coach no disponible**<br>Dado que el coach ha desactivado temporalmente su perfil,<br>Cuando el usuario intenta acceder a su perfil mediante un enlace directo,<br>Entonces el sistema muestra el mensaje "Este perfil no está disponible en este momento" y sugiere coaches similares disponibles. | 1 | EP02 |                                                                                                                                                                                                                                                                                                                                                                                                                            | 1            | EP02 |
| US08 | Reserva de sesión | Como usuario, quiero reservar sesiones con un coach para asegurar un horario de entrenamiento personalizado. | **Escenario 1: Reserva exitosa con horario disponible**<br>Dado que el usuario ha seleccionado un coach con disponibilidad confirmada,<br>Cuando selecciona un horario disponible y confirma la reserva,<br>Entonces el sistema crea la sesión con estado "SCHEDULED", notifica al coach por correo electrónico, y muestra al usuario la confirmación con los detalles de la sesión (fecha, hora, duración y coach).<br><br>**Escenario 2: Horario ya ocupado (concurrencia)**<br>Dado que dos usuarios intentan reservar el mismo horario simultáneamente,<br>Cuando el segundo usuario confirma la reserva,<br>Entonces el sistema rechaza la solicitud con el mensaje "Este horario ya no está disponible. Por favor selecciona otro horario" y muestra los próximos 3 horarios disponibles del mismo coach.<br><br>**Escenario 3: Coach cancela la sesión**<br>Dado que una sesión ha sido reservada y confirmada,<br>Cuando el coach cancela la sesión desde su panel,<br>Entonces el sistema notifica al usuario con el mensaje "Tu sesión del [fecha] ha sido cancelada por el coach. Puedes reservar otra sesión sin costo adicional" y libera el horario en el calendario del coach. | 2 | EP02 |                                                                                                                                                                                                                                                                                                                                                                                                                               | 2            | EP02 |
...
| US24 | Reconocimiento de alimentos con IA | Como usuario, quiero que la IA identifique automáticamente los alimentos en mis fotos de comida para no tener que ingresar cada ingrediente manualmente. | **Escenario 1: Identificación exitosa con imagen nítida**<br>Dado que el usuario ha subido una foto nítida de su plato,<br>Cuando la IA procesa la imagen con suficiente resolución y contraste,<br>Entonces el sistema identifica los alimentos detectados (ej. "Pollo a la plancha", "Ensalada mixta", "Arroz blanco"), muestra la lista con porcentajes de confianza por alimento, y precalcula los macronutrientes estimados.<br><br>**Escenario 2: Imagen con baja calidad o poca iluminación**<br>Dado que el usuario sube una foto borrosa o tomada con poca luz,<br>Cuando la IA no puede identificar los alimentos con una confianza mínima del 60%,<br>Entonces el sistema muestra el mensaje "No pudimos identificar los alimentos con precisión. Por favor sube una imagen con mejor iluminación o más nítida" y ofrece la opción de registrar los alimentos manualmente.<br><br>**Escenario 3: Plato con alimentos no reconocidos en la base de datos**<br>Dado que el usuario fotografía un plato típico peruano poco común,<br>Cuando la IA detecta ingredientes pero con confianza baja,<br>Entonces el sistema muestra los alimentos detectados con una advertencia "Detección incierta — te recomendamos revisar y ajustar las cantidades" y permite editar cada ítem antes de guardar el registro. | 8 | EP06 |                                                                                                                                                                                                                                                                                                                                                                                         | 8            | EP06 |
